...
var emptyCell;
const wallCells = [
    "1,1", "1,2", "1,3", "1,4", "2,2", "2,3", "2,4", "3,4", "3,3", "3,2", "3,1", "2,1",
    "1,7", "1,8", "1,9", "1,10", "2,10", "3,10", "3,9", "3,8", "3,7",
    "0,12", "1,12", "0,13", "1,13",
...
function Start() {
    ...
    interval = setInterval(UpdateMonsterPosition, 750);
}
    ...
    for (var i = 0; i < 15; i++) {
        for (var j = 0; j < 15; j++) {
            ...
            if (MonsVal === 7) {
                ...
                context.fillStyle = "#ef843c"; //color
                context.fill();
                context.fillStyle = "white"; //color
                context.font = "bold 10px Arial";
